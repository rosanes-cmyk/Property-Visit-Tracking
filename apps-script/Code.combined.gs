 ...
 *   saying so. The parts are split and rebuilt in local time instead.
 *
 ...
 *
 * The accepted window is deliberately wide — 2015 to five years ahead — because the imported legacy rows
 * go back to 2023 and a genuine booking can be a long way out. It is here to catch a manufactured date,
 * not to police what the team types.
 */
